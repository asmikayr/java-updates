...
public class Main {
    public static void main(String[] args) {
        ...
        Predicate<Integer> pred = (p) -> p%2 == 0 ? true : false; //implementation of the functional interface abstract method
        ...
        Calculate s4 = new Calculator() :: findMultiply;//:: called Method reference
